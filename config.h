...
/*************************************************************************************************/
/*****************                                                                 ***************/
/****************  SECTION  A - VTOL-SLT SETUP                                             *******/
/*****************                                                                 ***************/
/*************************************************************************************************/

//VTOL-SLT
#define SFF_THR 1500  //Thrust value in SFF mode
#define FFF_MAXTHROTTLE 2000

//VTOL-TS
#define HOV2FFF_BOOST 150
#define FFF2HOV_THR 1500
#define FFF_PITCH_ANGLE -750
#define FFF_PITCH_THRESHOLD 50

//VTOL_TR
#define TRANS_SERVO_HOV 1100
#define TRANS_SERVO_SFF 1350
#define TRANS_SERVO_FFF 1750
#define TRANS_SERVO_STEP 1

/*************************************************************************************************/
/*****************                                                                 ***************/
/****************  SECTION  B - LFP Telemetry                                              *******/
/*****************                                                                 ***************/
/*************************************************************************************************/
...
/*************************************************************************************************/
  ...
  /**************************    The type of multicopter    ****************************/
    ...
    //#define AIRPLANE
    //#define AIRPLANE_VTAIL  //和AIRPLANE一起使用时将开启V尾混动
  ...
  /**************************************************************************************/
    ...
    /***************************    Combined IMU Boards    ********************************/
      ...
      //#define LazeMWC        //Lazeman's board with GY-87, onboard battery adc and rssi input
