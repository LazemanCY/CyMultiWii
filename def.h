...
/***************             VTOL configurations                   ********************/
/**************************************************************************************/
#if defined(VTOL_SLT) || defined(VTOL_TS) || defined(VTOL_TR)
  #define VTOL
#endif
...
//VTOL_SLT/TR  
  ...
  #define PRI_SERVO_TO    4   //Add one more servo for fixed wing type 17-11-4
#endif
...
/**************************   atmega328P (Promini)  ************************************/
  ...
  #endif 
  #define PPM_PIN_INTERRUPT          {pinMode(2, INPUT);attachInterrupt(digitalPinToInterrupt(2), rxInt, RISING);} //PIN 2
  ...
  #define SERVO_1_PINMODE            pinMode(A0,OUTPUT); // TILT_PITCH - WING left  //VTOL SLT Servo
  #define SERVO_1_PIN_HIGH           PORTC |= 1<<0;
  #define SERVO_1_PIN_LOW            PORTC &= ~(1<<0);
  #define SERVO_2_PINMODE            pinMode(A1,OUTPUT); // TILT_ROLL  - WING right //VTOL SLT Servo
...
/**************************  all the Mega types  ***********************************/
  ...
  #define SERVO_1_PINMODE            pinMode(34,OUTPUT);pinMode(44,OUTPUT); // TILT_PITCH - WING left  //VTOL servo 1
  #define SERVO_1_PIN_HIGH           PORTC |= 1<<3;PORTL |= 1<<5;
  #define SERVO_1_PIN_LOW            PORTC &= ~(1<<3);PORTL &= ~(1<<5);
  #define SERVO_2_PINMODE            pinMode(35,OUTPUT);pinMode(45,OUTPUT); // TILT_ROLL  - WING right //VTOL servo 2
...
#elif defined(VTOL_SLT) || defined(VTOL_TR)  //VTOL-SLT/TR use Airplane type
  #define MULTITYPE 14
